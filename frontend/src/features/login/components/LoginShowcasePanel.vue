...
<template>
  ...
  >
    <div
      class="absolute -right-14 -top-16 h-56 w-56 rounded-full bg-orange-500/30 blur-3xl"
    />
    <div
      class="absolute -bottom-20 -left-14 h-56 w-56 rounded-full bg-orange-600/20 blur-3xl"
    />

    <div class="relative">
      <p
        class="text-xs font-semibold uppercase tracking-[0.28em] text-zinc-400"
      >
        SYSTOCK
      </p>
